...
with tab_ai:
    ...
    if not st.session_state.messages:
        html_items.append(
            f'<div class="welcome-box"><div class="welcome-title">{{current_user_name}or朋友}，盡情與 AI 規劃行程吧！</div><div class="welcome-sub">當前模式：【{ai_mode}】｜ 可以幫你檢視近期的空檔時間、安排行程、撰寫文案或解答各種問題</div></div>'
        )
    else:
